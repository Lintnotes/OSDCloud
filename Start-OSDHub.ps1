...
$WPFStartButton.Add_Click({
    ...
    Start-Process cmd.exe -ArgumentList " /c start Powershell -WindowStyle 'Hidden' iex (irm https://raw.githubusercontent.com/Lintnotes/OSDCloud/main/OSDBranding.ps1)"
